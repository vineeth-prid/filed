...
import {
  ...
  ArrowRight, Layers, Activity, Plug, Server, GraduationCap, Inbox,
} from "lucide-react";
    ...
    <div data-testid="admin-home-page" className="min-h-screen bg-offwhite text-navy">
      ...
      <main className="max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-5 mb-10">
          ...
          <Link to="/admin/leads" data-testid="module-leads"
            className="group border border-border bg-white p-6 hover:border-navy transition-colors flex flex-col">
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-navy flex items-center justify-center group-hover:bg-emerald2 transition-colors">
                  <Inbox className="w-5 h-5 text-white group-hover:text-navy transition-colors" strokeWidth={1.6} />
                </div>
                <div>
                  <div className="font-mono text-[10px] text-slate2 uppercase tracking-wider">Assistant · CRM</div>
                  <div className="font-heading font-bold text-lg text-navy tracking-tight">Leads</div>
                </div>
              </div>
              <ArrowRight className="w-5 h-5 text-slate2 group-hover:text-navy group-hover:translate-x-1 transition-all" />
            </div>
            <p className="mt-4 text-sm text-slate2 leading-relaxed">
              Admission enquiries captured by the on-site AI assistant — review contact details, track status (new → contacted → converted), read the chat, and add notes.
            </p>
          </Link>
        </div>
